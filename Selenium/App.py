...
PATH = r"C:\Users\poolj\Desktop\Selenium\chromedriver.exe"
...
username.clear()
password.clear()
username.send_keys("aspiert230@gmail.com")
password.send_keys("jeanpool123")
...
#searchbox
time.sleep(3)
searchbox = driver.find_element_by_css_selector("input[placeholder='Busca']")
searchbox.clear()
